...
<div class="container"><form action="{{url('/nefropediatria/'.$nefropediatria->id)}}" method="post">
  ...
  <h1 id="AntecedentesTitulo" class="text-center bluenefro"><i class="bi bi-x-diamond"></i> Editar Consulta Nefropediatría</h1>
        ...
        <div class="col-1">
                ...
                <div class="container">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="exampleFormControlTextarea1" name="analisis" value="{{ isset($nefropediatria->analisis)?$nefropediatria->analisis:old('analisis') }}" id="analisis" rows="13">{{ isset($nefropediatria->analisis)?$nefropediatria->analisis:old('analisis') }}</textarea>      
                    </div>
            <div class="col-1">
                </div>
            </div>
        ...
        <div class="col-1">
                ...
                <div class="container">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="exampleFormControlTextarea1" name="diagnostico" value="{{ isset($nefropediatria->diagnostico)?$nefropediatria->diagnostico:old('diagnostico') }}" id="diagnostico" rows="13">{{ isset($nefropediatria->diagnostico)?$nefropediatria->diagnostico:old('diagnostico') }}</textarea>      
                    </div>
            <div class="col-1">
                </div>
            </div>
        ...
        <div class="col-1">
                ...
                <div class="container">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="exampleFormControlTextarea1" name="tratamiento" value="{{ isset($nefropediatria->tratamiento)?$nefropediatria->tratamiento:old('tratamiento') }}" id="tratamiento" rows="11">{{ isset($nefropediatria->tratamiento)?$nefropediatria->tratamiento:old('tratamiento') }}</textarea>      
                    </div>
